...
class _HomeState extends State<Home> {
  ...
  Widget Text2Notes() {
    return Container(
      ...
      child: Text(
        "All Notes",
        style:
            TextStyle(color: Colors.white, fontSize: 30, fontFamily: 'MuktaM'),
      ),
    );
  }
  ...
  Widget BottomBarWidget() {
    return Row(
      ...
      children: [AddButton(context), BackButton()],
    );
  }
            ...
            return Expanded(
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return NotesListWIdget(data, index);
                },
              ),
            );
          }
  ...
  Widget NotesListWIdget(List<Note> data, int index) {
